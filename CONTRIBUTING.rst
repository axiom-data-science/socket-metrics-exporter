...
socket-metrics-exporter could always use more documentation, whether as part of the
official socket-metrics-exporter docs, in docstrings, or even on the web in blog posts,
articles, and such.
